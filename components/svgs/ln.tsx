...
const Ln = ({ className }: Props) => {
  return (
    ...
    >
      <path
        d="M30.6,5.2C27.2,1.9,22.7,0,17.9,0C13.2,0,8.6,1.9,5.2,5.2S0,13.2,0,17.9c0,4.8,1.9,9.3,5.2,12.7
                    ...
                    c-1.5,0-2.3,1-2.3,2.7v6.3h-3.6v-12h3.6v1.6c0.4-0.6,0.9-1.1,1.6-1.5c0.6-0.3,1.3-0.5,2.1-0.5c2.5,0,4.4,1.6,4.4,4.8V25.9z"
      ></path>
    </svg>
  );
};
