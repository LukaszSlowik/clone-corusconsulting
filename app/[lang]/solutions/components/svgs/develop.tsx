...
const Develop = (props: Props) => {
  return (
    <motion.svg
      ...
      //   className="key-board moveLeftFast"
      id="key-board"
      x="0px"
      y="0px"
    ...
    :host(.key_show) #default_key_7 {
        animation-name      : shadow-solid;
        animation-duration  : 0.1s;
        animation-delay: 0.6s;
        animation-fill-mode : forwards;
    }
    :host(.key_show) #default_key_4 {
        animation-name      : shadow-solid;
        animation-duration  : 0.1s;
        animation-delay: 0.7s;
        animation-fill-mode : forwards;
    }
    :host(.key_show) #default_key_12 {
        animation-name      : shadow-solid;
        animation-duration  : 0.1s;
        animation-delay: 0.8s;
        animation-fill-mode : forwards;
    }
    :host(.key_show) #default_key_3 {
        animation-name      : shadow-solid;
        animation-duration  : 0.1s;
        animation-delay: 0.9s;
        animation-fill-mode : forwards;
    }
    :host(.key_show) #default_key_9 {
        animation-name      : shadow-solid;
        animation-duration  : 0.1s;
        animation-delay: 1s;
        animation-fill-mode : forwards;
    }
    :host(.key_show) #default_key_11 {
        animation-name      : shadow-solid;
        animation-duration  : 0.1s;
        animation-delay: 1.1s;
        animation-fill-mode : forwards;
    }
    :host(.key_show) #default_key_1 {
        animation-name      : shadow-solid;
        animation-duration  : 0.1s;
        animation-delay: 1.2s;
        animation-fill-mode : forwards;
    }
    :host(.key_show) #default_key_2 {
        animation-name      : shadow-solid;
        animation-duration  : 0.1s;
        animation-delay: 1.3s;
        animation-fill-mode : forwards;
    }
    :host(.key_show) #default_key_8 {
        animation-name      : shadow-solid;
        animation-duration  : 0.1s;
        animation-delay: 1.4s;
        animation-fill-mode : forwards;
    }
    :host(.key_show) #default_key_5 {
        animation-name      : shadow-solid;
        animation-duration  : 0.1s;
        animation-delay: 1.5s;
        animation-fill-mode : forwards;
    }
    :host(.key_show) #default_key_10 {
        animation-name      : shadow-solid;
        animation-duration  : 0.1s;
