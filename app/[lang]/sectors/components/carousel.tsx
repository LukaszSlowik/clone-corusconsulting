...
//  import  type EmblaCarouselType as CarouselApi,
//  import type EmblaOptionsType as CarouselOptions,
//   import type EmblaPluginType as CarouselPlugin,
//   type EmblaOptionsType as CarouselOptions,
//   type EmblaPluginType as CarouselPlugin,
...
const CarouselPrevious = ({ className }: { className?: string }) => {
  ...
  return (
    <button
      className={cn(
        // " absolute    hover:bg-black hover:text-white",
        // orientation === "horizontal"
